...
class Notification {
	...
	public function getUnreadNumber() {
		...
		while($row = mysqli_fetch_array($query)) {
			...
			<div class='resultDisplay resultDisplayNotification' style='" . $style . "'>
				<div class='notificationsPorfilePic'>
	...
	public function inseetNotification($post_id, $user_to, $type){
		$userLoggedIn = $this->user_obj->getUsername();
		$userLoggedIdName=$this->user_obj->getFirstAndLastName();

		$date_time=date("Y-m-d H:i:s");

		switch ($type) {
			 case 'comment':
			 $message = $userLoggedIdName . " comment on your post";
			 break;

			 case 'like':
			 $message = $userLoggedIdName . " liked your post";
			 break;

			 case 'profile_post':
			 $message = $userLoggedIdName . " posted on your profile";
			 break;

			 case 'comment_non_owner':
			 $message = $userLoggedIdName . " commented on a post you commented on";
			 break;

		 	 case 'profile_comment':
			 $message = $userLoggedIdName . " commented on your profile post";
			 break;
		}
