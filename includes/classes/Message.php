...
class Message {
	...
	public function getMessages($otherUser) {
		...
		while($row = mysqli_fetch_array($get_messages_query)) {
			...
			$div_top = ($user_to == $userLoggedIn) ? "<div class='break'></div><div class='message' id='green'>" : "<div class='break'></div><div class='message' id='blue'>";
	...
	public function getLatestMessage($userLoggedIn, $user2) {
		...
		if($interval->y >= 1) {
			if($interval->y == 1)
				$time_message = $interval->y . " year ago"; //1
			else 
				$time_message = $interval->y . " years ago"; //1+ 
		}
